        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://supremecourt.gov.ng" target="__blank" className="text-gray-400 hover:text-[#D4AF37] transition duration-300 cursor-pointer">
                  Supreme Court
                </Link>
              </li>
              <li>
                <Link href="https://www.courtofappeal.gov.ng" target="__blank" className="text-gray-400 hover:text-[#D4AF37] transition duration-300 cursor-pointer">
                  Court of Appeal
                </Link>
              </li>
              <li>
                <Link href="https://njc.gov.ng" target="__blank" className="text-gray-400 hover:text-[#D4AF37] transition duration-300 cursor-pointer">
                  National Judicial Council
                </Link>
              </li>
              <li>
                <Link href="https://fhc.gov.ng" target="__blank" className="text-gray-400 hover:text-[#D4AF37] transition duration-300 cursor-pointer">
                  Federal High Court
                </Link>
              </li>
            </ul>
